...
urlpatterns = [
    ...
    path('accounts/profile/<str:slug>/', profile_bb_detail, name='profile_bb_detail'),
    ...
    path('<str:rubric_slug>/<str:slug>/', detail, name='detail'),
    path('<str:rubric_slug>/', by_rubric, name='by_rubric'),
    path('<str:page>', other_page, name='other'),
    path('<str:rubric_slug>/<str:slug>/<str:url>', redirect_view),
